        ...
        <>
          <div className="flex flex-col justify-center mt-16">
            ...
            {!currentScan &&
              ...
              !startScan &&
              user.permissions.includes('super_admin') && (
                <div className="mx-auto my-8 mt-12 flex flex-col gap-4 items-center">
                  <button
          ...
          <div className="rounded-2xl relative bg-white flex flex-col justify-between p-6 max-w-md mx-auto">
            ...
            <div className="my-7 flex flex-col gap-y-4">
              ...
              <p className="text-red-600 font-semibold">
                ⚠️ This action cannot be undone! Points earned from check-ins will also be deducted.
              </p>
        ...
        <div className="flex items-center justify-center min-h-screen">
          ...
          <div className="rounded-2xl relative bg-white flex flex-col justify-between p-6 max-w-md mx-auto">
            ...
            <div className="my-7 flex flex-col gap-y-4">
              ...
              <p className="text-red-600 font-semibold">
                ⚠️ This action cannot be undone! All user points will be reset to zero.
              </p>
              <p className="text-gray-600">Are you absolutely sure you want to proceed?</p>
            </div>
